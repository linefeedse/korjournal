...
public class MyMultipartRequest extends Request<NetworkResponse> {
    ...
    public MyMultipartRequest(String url,
    ...
    public byte[] getBody() throws AuthFailureError {
        ...
        try {
            ...
            dos.writeBytes("--" + boundary + dashDash + lineEnd);
    ...
    private void buildTextPart(DataOutputStream dataOutputStream, String parameterName, String parameterValue) throws IOException {
        dataOutputStream.writeBytes(dashDash + boundary + lineEnd);
    ...
    public class DataPart {
         ...
         * @param mimeType mime data like "image/jpeg"
         */
        public DataPart(String name, String filePath, String mimeType) throws IOException {
            fileName = name;
            type = mimeType;
            ...
            try {
                ios = new FileInputStream(datafile);
